package com.kodex.navigationmvvm
...
import com.kodex.navigationmvvm.screens.hello.HelloFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.registerFragmentLifecycleCallbacks(transientCallbacks, false )
    }

    override fun onDestroy() {
        super.onDestroy()
        supportFragmentManager.unregisterFragmentLifecycleCallbacks(transientCallbacks)
    }
    ...
    private val transientCallbacks = object :FragmentManager.FragmentLifecycleCallbacks(){
